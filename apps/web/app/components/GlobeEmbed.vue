...
onMounted(async () => {
  try {
    ...
    _deselect = () => { restoreAll(); selectedEntityId = null; clearOrbit() }
...
.search-results li { padding: 6px 11px; color: #e0e0f0; font-size: 12px; cursor: pointer; }
...
.info-name { font-size: 14px; font-weight: 700; color: #6BD8FF; margin-bottom: 10px; padding-right: 18px; }
...
.info-value { color: #e0e0f0; font-family: monospace; font-size: 10px; }
</style>
